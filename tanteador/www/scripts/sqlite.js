...
function querySuccess(tx, results) {
  ...
  var tblText = "<table data-role='table' id='table-colum-toggle' data-mode='columntoggle' class='ui-responsive table-stroke' data-column-btn-text='Columnas..'>";
  tblText += "<thead><tr><th data-priority='2'>Id</th><th data-priority='3'>Local</th><th data-priority='2'>Visitante</th><th data-priority='3'>Resultado</th></tr></thead><tbody>"
  var len = results.rows.length;
  for (var i = 0; i < len; i++) {
    var tmpArgs = results.rows.item(i).id + ",'" + results.rows.item(i).name
            + "','" + results.rows.item(i).number + "'";
